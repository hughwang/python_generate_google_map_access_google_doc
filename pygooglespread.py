...
DBfile = 'K:\\eproj\\trunk\\USPS_Route\\DM.accdb'
...
def    ProcessForState(config_data,worksheet,State,Google_Map_KML,collum_name_dic):
        ...
        SQL = "SELECT ID, Address,City,State,Zip,Latitude,Longitude from Address_Collect  order by State,Zip,ID " 
        cursor.execute(SQL)
        ...
        for Street in placesmarks:
                ...
                if not StreetName in streetsAssign:
                        ...
                        AddStreetToSpread(config_data,worksheet,collum_name_dic,id, StreetName,list_length,this_city,this_State,this_Address)
